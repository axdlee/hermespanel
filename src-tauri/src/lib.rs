...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::extensions::import_plugin,
            commands::extensions::create_plugin,
            commands::extensions::read_plugin_manifest,
            commands::extensions::save_plugin_manifest,
            commands::extensions::read_plugin_readme,
            commands::extensions::save_plugin_readme,
            commands::extensions::delete_local_plugin,
            commands::sessions::list_sessions,
            commands::sessions::get_session_detail,
            commands::skills::list_skills,
            commands::skills::read_skill_file,
            commands::skills::save_skill_file,
            commands::skills::save_skill_frontmatter,
